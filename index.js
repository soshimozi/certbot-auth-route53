...
const deployHook = async () => {
    ...
    await uploadS3WithEnvelope(process.env.DOMAIN_BUCKET, `External/CA/${process.env.RENEWED_DOMAINS}/fullchain.pem`, fullChain.toString('utf8'));
    await uploadS3WithEnvelope(process.env.DOMAIN_BUCKET, `External/CA/${process.env.RENEWED_DOMAINS}/fullchain.pem`, privKey.toString('utf8'));
};
